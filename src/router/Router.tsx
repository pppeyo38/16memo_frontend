...
export const Router = memo(() => {
	return (
		<Routes>
			...
			<Route
				path="/signup"
				element={<HeaderLayout><Singup /></HeaderLayout>}
			/>
			<Route
				path="/login"
				element={<HeaderLayout><Login /></HeaderLayout>}
			/>
			<Route
				path="/"
				element={<HeaderLayout><Files /></HeaderLayout>}
			/>
			<Route
				path="/:fileName"
				element={<HeaderLayout><MemoFiles /></HeaderLayout>}
			/>
			<Route path="/memo/:memoId" element={<HeaderLayout><MemoId /></HeaderLayout>} />
			{/* TODO: クエリパラメータ */}
			<Route
				path="/search"
			...
			<Route
				...
				element={<HeaderLayout><SettingName/></HeaderLayout>}
			/>
			<Route
				path="/setting/password"
				element={<HeaderLayout><SettingPw /></HeaderLayout>}
			/>
			<Route
				path="/setting/deactivate"
				element={<HeaderLayout><SettingDeactivate /></HeaderLayout>}
			/>
			<Route
				path="/memo/add"
				element={<HeaderLayout><MemoAdd /></HeaderLayout>}
			/>
			<Route
				path="/memo/:memoId/edit"
				element={<HeaderLayout><MemoEdit /></HeaderLayout>}
			/>
		</Routes>
	)
})
